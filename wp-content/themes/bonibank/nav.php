                    ...
                    <div class="d-none d-lg-block">
                        <ul class="menu nav nav-tabs justify-content-center">
                            <li class="nav-item car">
                                <a class="nav-link active" onclick="location.href='<?php echo get_home_url(); ?>'">汽車貸款</a>
                            </li>
                            <li class="nav-item credit">
                                <a class="nav-link" onclick="location.href='<?php echo get_permalink(get_page_by_path('credit')); ?>'">信用貸款</a>
                            </li>
